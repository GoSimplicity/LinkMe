...
func InitWebServer() *Cmd {
	...
	scheduler := ioc.InitScheduler()
	postService := service.NewPostService(postRepository, logger, interactiveService, checkService, producer, historyRepository, scheduler)
