...
func InitWebServer() *Cmd {
	...
	postService := service.NewPostService(postRepository, logger, interactiveService, checkService, postProducer, historyRepository, checkRepository, searchRepository)
	...
	engine := ioc.InitWebServer(userHandler, postHandler, historyHandler, checkHandler, v, permissionHandler, rankingHandler, plateHandler, activityHandler, commentHandler, searchHandler)
