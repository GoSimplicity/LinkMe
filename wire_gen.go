...
func InitWebServer() *Cmd {
	...
	historyDAO := dao.NewHistoryDAO(db, logger)
	historyRepository := repository.NewHistoryRepository(logger, historyDAO)
	...
	engine := ioc.InitWebServer(userHandler, postHandler, historyHandler, v)
