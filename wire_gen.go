...
func InitWebServer() *Cmd {
	...
	commentRepository := repository.NewCommentService(commentDAO)
	commentService := service.NewCommentService(commentRepository)
	commentHandler := api.NewCommentHandler(commentService)
	engine := ioc.InitWebServer(userHandler, postHandler, historyHandler, checkHandler, v, permissionHandler, rankingHandler, plateHandler, activityHandler, commentHandler)
