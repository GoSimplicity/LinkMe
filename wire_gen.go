...
func InitWebServer() *Cmd {
	...
	lotteryDrawCache := cache.NewLotteryDrawCache(cmdable, logger)
	lotteryDrawRepository := repository.NewLotteryDrawRepository(lotteryDrawDAO, lotteryDrawCache, logger)
	lotteryDrawService := service.NewLotteryDrawService(lotteryDrawRepository)
