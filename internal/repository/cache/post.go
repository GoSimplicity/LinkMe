...
type PostCache interface {
	GetFirstPage(ctx context.Context, id int64) ([]domain.Post, error)    // 获取用户的第一页帖子缓存
	SetFirstPage(ctx context.Context, id int64, post []domain.Post) error // 设置用户的第一页帖子缓存
